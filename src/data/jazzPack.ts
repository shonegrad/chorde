...
export const JAZZ_PACK: Song[] = [
    {
        ...
        key: 'Em', // G major / Em relative
        capo: 0,
        createdAt: Date.now(),
        updatedAt: Date.now(),
        content: `{start_of_verse}
[Am7]The falling [D7]leaves [Gmaj7]drift by the [Cmaj7]window
[F#m7b5]The autumn [B7]leaves [Em7]of red and [E7]gold
[Am7]I see your [D7]lips, [Gmaj7]the summer [Cmaj7]kisses
[F#m7b5]The sun-burned [B7]hands [Em7]I used to [Em]hold`
    },
    {
...
I'll never [Dm7]use [G7]them`
    },
    {
        ...
        content: `{start_of_verse}
Summ[Am6]ertime, [E7]
And the livin' is [Am6]easy [E7]
Fish are [Dm7]jumpin' [G7]
And the cotton is [Cmaj7]high [E7]
Oh, your [Am6]daddy's [E7]rich
And your [Am6]mamma's good [D7]lookin'
[C]So hush little [Am]baby
[Dm7]Don't [E7]you [Am6]cry`
    },
    {
        id: 'jazz-take-the-a-train',
        title: 'Take the "A" Train',
        artist: 'Duke Ellington',
        tags: ['jazz', 'swing', 'big-band'],
        key: 'C',
        capo: 0,
        createdAt: Date.now(),
        updatedAt: Date.now(),
...
[F]Bye [Db7]Bye [F]Black[D7]bird`
    },
    {
        ...
        artist: 'Jazz Standard',
        tags: ['jazz', 'swing', 'harlem-globetrotters'],
...
(Doo - ah, doo - ah, doo - ah, doo - ah, doo - ah, doo - ah, doo - ah, doo - ah)`
    },
    {
        ...
        tags: ['jazz', 'gypsy-jazz', 'instrumental'],
        key: 'Am',
        capo: 0,
        createdAt: Date.now(),
        updatedAt: Date.now(),
