...
[Bm]Try to [G]see it [D]once my [F#]way`
    },
    {
        ...
        tags: ['grunge', '90s', 'acoustic'],
        key: 'Em',
        capo: 0, // Half step down normally
        createdAt: Date.now(),
        updatedAt: Date.now(),
        content: `{start_of_verse}
[Em]We chase [G]misprinted [D]lies [Cadd9]
[Em]We face [G]the path of [D]time [Cadd9]
[Em]And yet [G]I fight
And [D]yet I fight [Cadd9]
[Em]This battle [G]all alone [D] [Cadd9]
[Em]No one [G]to cry to [D] [Cadd9]
[Em]No place [G]to call home [D] [Cadd9]`
    },
    {
...
[D]I [C]stay [A]away`
    ...
    // RED HOT CHILI PEPPERS
    {
        ...
        updatedAt: Date.now(),
        content: `{start_of_verse}
[E]Sometimes I [B]feel
Like I [C#m]don't have a [A]partner
[E]Sometimes I [B]feel
Like [C#m]my only [A]friend
[E]Is the city I [B]live in
The [C#m]city of [A]angels
[E]Lonely as [B]I am
To[C#m]gether we [A]cry`
    },
    {
